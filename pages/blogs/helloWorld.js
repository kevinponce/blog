{
  ...
  "title": "OSX install matplotlib without anaconda | Blog",
  "component": "blogs-post",
  "params": {
    "blog": {
      "title": "OSX install matplotlib without anaconda",
      "description": "Hello world is a basic app that everyone first starts out with. :)",
      ...
      "date": "1/12",
      "tags": ["python", "matplotlib", "lucky", "duck", "hello"]
    },
    "menu-theme": "dark"
  }
}
